...
'''Dica interessante do professor Guanabara sobre uma maneira interessante de realizar a verificação de se determinada média é menor que 'X' e maior que 'Y'. Exemplo: 'if 7 > média >= 5:' '''
